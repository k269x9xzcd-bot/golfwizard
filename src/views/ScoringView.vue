              ...
              <template v-for="(group, gi) in sortedPlayerGroups" :key="'grp-'+gi">
                ...
                >
                  ...
                  <td
                    ...
                    :class="{ 'cell-winner': isNetWinner(group.member.id, h), 'cell-defidget': isFidgetWinner(group.member.id, h), [sixesCellClass(group.member.id, h)]: true, 'cell-discarded': fourteenGame && isDiscarded(group.member.id, h) }"
