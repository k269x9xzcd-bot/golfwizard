...
export const WOLF_HOLE_MODES=[{k:'normal',l:'🤝 Partner'},{k:'lone',l:'🐺 Lone'},{k:'blind',l:'🙈 Blind'}];
  ...
  fiveThreeOne:{icon:'5️⃣',name:'5-3-1',role:'main',
    ...
    variations:'Sweep bonus (toggle): if the sole winner beats 2nd place by ≥2 net strokes on a hole, they take all 9 points and the other two get 0. Birdie bonus (toggle): if exactly one player nets a birdie on a hole, they earn +1 extra point on top of their rank points (if 2+ players birdie, no bonus applies). Both variations are opt-in per round — agree before teeing off.',
    variationConfig: {
