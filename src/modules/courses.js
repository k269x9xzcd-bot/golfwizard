...
export const WOLF_HOLE_MODES=[{k:'normal',l:'🤝 Partner'},{k:'lone',l:'🐺 Lone'},{k:'blind',l:'🙈 Blind'}];
  ...
  fourteen:{icon:'🎯',name:'14 Holes',role:'main',
  ...
  sixes:{icon:'🎲',name:'Sixes',role:'main',
    desc:'4-player rotating partner game. Teams switch every 6 holes so everyone partners with everyone.',
    players:'4 players (rotating 2v2)',
    rules:'Holes 1-6: P1+P2 vs P3+P4. Holes 7-12: P1+P3 vs P2+P4. Holes 13-18: P1+P4 vs P2+P3. Each hole: winning team earns 4pts, losing team 2pts, tie = 3/3. After 18, settle pairwise — each player pays/collects based on point differential × $/pt.',
    wagering:'$1/pt default. With per-hole scoring, a 6-0 segment sweep = 24 vs 0 pts (24pt swing). Typical exposure: $10–$30/player at $1/pt.',
    hcpNote:'Low-man method: subtract lowest net handicap in the foursome from all players.',
    example:'Seg 1 (holes 1-6): SP+AS beat MS+CH 4-2 → SP+AS earn 16pts, MS+CH earn 8pts. After 18, SP has 45pts, MS has 27pts → MS pays SP (45-27)×$1 = $18.'},
